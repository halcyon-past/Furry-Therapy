...
export default function About() {
    return (
        <div className="About w-full h-screen relative">
            <div className="absolute top-28 left-2 h-[500px] rounded-lg bg-[#ffffff55] z-10 w-11/12 p-2 text-left backdrop-blur-sm sm:w-7/12 sm:top-28 sm:left-20 sm:p-20">
